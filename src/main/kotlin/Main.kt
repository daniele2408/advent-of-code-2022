...
import solutions.day12hillclimbingalgorithm.fewestStepRequired
...
//    println("Monkey business level after 10000 rounds is ${levelOfMonkeyBusinessAfterNRoundsHighStress(10000)}")
    ...
    println("############## DAY 12 ##############")
    println("Fewest step required to move from current position to the location is ${fewestStepRequired()}")
